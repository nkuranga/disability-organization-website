      ...
      <section className="mb-32 text-gray-800">
        ...
        >
          <div className="text-white flex justify-center items-center mt-20">
            <h1 className="font-extrabold text-3xl uppercase ">Contact us</h1>
          </div>
        </div>
          ...
          >
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 mb-12">
              <div className="mb-12 lg:mb-0 text-center mx-auto">
                ...
                <h6 className="font-medium">Rwanda</h6>
              </div>
              <div className="mb-12 lg:mb-0 text-center mx-auto">
                <svg
                  className="w-8 h-8 text-blue-600 mb-6 mx-auto"
                ...
                <h6 className="font-medium">Kigali, KN 200</h6>
              </div>
              <div className="mb-6 md:mb-0 text-center mx-auto">
                ...
                <h6 className="font-medium">+ (25) 0780263922</h6>
              </div>
